...
#define CAN_MCR_AEN                 (1U << 12)
#define CAN_MCR_LPRIO_EN            (1U << 13)
#define CAN_MCR_BCC                 (1U << 16)
#define CAN_MCR_SRX_DIS             (1U << 17)
#define CAN_MCR_LPM_ACK             (1U << 20)
#define CAN_MCR_WRN_EN              (1U << 21)
#define CAN_MCR_SUPV                (1U << 23)
#define CAN_MCR_FRZ_ACK             (1U << 24)
#define CAN_MCR_WAK_MSK             (1U << 26)
#define CAN_MCR_NOT_RDY             (1U << 27)
#define CAN_MCR_HALT                (1U << 28)
#define CAN_MCR_FEN                 (1U << 29)
...
#define CAN_ESR_TWRN_INT            (1 << 17)
#define CAN_ESR_RWRN_INT            (1 << 16)
/** @} */
